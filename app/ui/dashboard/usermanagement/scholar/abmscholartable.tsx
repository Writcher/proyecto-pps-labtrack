...
export default function ABMScholarTable({ usercareers, scholarships, laboratory_id }: AMBScholarTableProps ) {
    ...
    const sortData = (data: UserGetScholar[]) => {
        return data.slice().sort((a, b) => {
            const aValue = a[sortColumn as keyof UserGetScholar] ?? ''; // Valor predeterminado si es null o undefined
            const bValue = b[sortColumn as keyof UserGetScholar] ?? ''; // Valor predeterminado si es null o undefined
